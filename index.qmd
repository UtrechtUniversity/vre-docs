...
**See [here](docs/workspace-catalogue.qmd) for a list of available workspace types and their documentation.**
...
- [Practical tips for responsible use](docs/responsible-use.qmd)
- [Terms of use](docs/terms-of-use.qmd)
- [Privacy](docs/privacy.qmd)
