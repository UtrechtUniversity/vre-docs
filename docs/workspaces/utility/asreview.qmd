...
Anyone who has access to your [Collaboration](../../glossary.qmd#collaboration) will be able to easily login to ASReview in their browser [using Single-Sign on](../../first-steps.qmd#webapplications-that-support-single-sign-on.). Since ASReview 2.0 supports multiple users, this workspace is ideal for crowd-based screening. You can even use it for a [screenathon](https://www.uu.nl/en/news/research-meets-sightseeing-reviewing-thousands-of-papers-in-utrechts-historical-gems)! Simply add the members of your screening group to your [Collaboration in SRAM](../../glossary.qmd#collaboration) and start screening together.

On ResearchCloud you will find two flavours of ASReview:

- ASReview (recommended for all normal screening purposes)
- ASReview [Dory](https://asreview.readthedocs.io/en/latest/lab/dory.html) (only recommended for special use cases with extra large or multi-lingual datasets, installs specialized heavy machine learning models which require GPUs)
...
To use the ASReview [Dory](https://asreview.readthedocs.io/en/latest/lab/dory.html) [Catalog Item](../../glossary#catalog-item) you will need to create a machine with GPUs, which are more expensive than CPUs. For this reason we recommend against using Dory for anything but advanced use cases (e.g. with multilingual datasets).
