...
## Access
This workspace can be accessed via the [Remote Desktop protocol](../../first-steps.qmd#remote-desktop-protocol). You need a TOTP to login to your workspace, see [Workspace access with TOTP](https://servicedesk.surf.nl/wiki/display/WIKI/Log+in+to+your+workspace#Logintoyourworkspace-WorkspaceAccesswithTOTP).
