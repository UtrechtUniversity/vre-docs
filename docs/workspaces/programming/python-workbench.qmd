...
::: {.callout-note}
Note that the python environments are created *separately* for each user in your [Collaboration](../../glossary.qmd#collaboration). This means each user can have their own clean python environments.
