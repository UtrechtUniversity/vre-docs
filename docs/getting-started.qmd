...
When you created a workspace and chose to attach a storage volume, the storage volume can be found via the following directory path: `/data/volume_2`
Typically you want to create a project folder in `volume_2` (e.g. `/data/volume_2/my_project`).
