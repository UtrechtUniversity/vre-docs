...
-	If you are member of multiple Collaborations (CO) select correct CO
-	If you are owner of multiple wallets select correct one
-	Select Cloud provider (Surf AWS or Surf HPC Cloud)
-	Select type VM (CPU, RAM, Storage)
-	Select persistent storage (created in step 3)
-	Set expiration date (default setting is 1 week)
-	Title (and description) workspace
-	Button submit
