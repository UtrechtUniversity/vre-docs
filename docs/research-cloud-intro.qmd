...
Managing memberships of the collaboration is done via a self-service portal (called [SRAM](https://servicedesk.surf.nl/wiki/display/IAM/SURF+Research+Access+Management)), 
