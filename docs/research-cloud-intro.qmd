...
## Getting started
Contact [UU Research IT](https://www.uu.nl/en/research/research-data-management/tools-services/software-and-computing/virtual-research-environments) for an intake meeting to get started. After a 30 minute intake you will have everything ready to start your first workspace. More info about the onboarding procedure can be found [here](onboarding.qmd)
