...
LLMs are often used to extract information from documents or images into structured output. As a final exercise we suggest to run the two examples in this blogpost on how to use Ollama for data extraction and image description: [Structured Outputs](https://ollama.com/blog/structured-outputs).
