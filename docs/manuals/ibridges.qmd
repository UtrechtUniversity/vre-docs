...
The instructions below describe the how to setup iBridges to transfer data between SURF Research Cloud and Yoda or any other iRODS instance. iBridges consists of three parts:

- as a python package 
- a command line interface (CLI)
- a graphical user interface (GUI)

With all three parts you can safely transfer your data between Yoda and your workspace.
...
The python package and the command line interface are available or can be made available on all workspaces while the graphical user interface will only work on desktop workspaces, i.e. workspaces where you will have a Windows or linux Desktop. 

### Prerequisites

You will need access to a Yoda or other iRODS instance which hosts your data.
