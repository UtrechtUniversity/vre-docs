...
- On desktop workspaces, open a terminal first by clicking applications in the top left corner and then click terminal. A terminal window will open. Here you can type and execute: `pip install ibridgesgui`.
