...
This guide shows you how to connect your local VS Code editor to a SURF Research Cloud workspace using SSH. This allows you to:

- **Edit code locally** with your familiar VS Code setup and extensions.
- **Execute code remotely** on the workspace with its computing resources and installed software.
- **Access workspace files** directly from your local editor.
- **Use workspace Python environments** (`uv`, `conda`, `pyenv`, etc.) seamlessly
...
If you try to use an extension that is not installed on the workspace, VS Code will prompt you to install it remotely. Click **"Install in SSH: myworkspace"** when prompted.
...
**Can I use an AI coding assistant on Research Cloud?**

Yes. Once connected via Remote-SSH, you can install AI coding assistant extensions in VS Code (like GitHub Copilot).

::: {.callout-warning}
**Disclaimer:** We do not endorse using any AI coding assistants. Users are responsible for:

- Ensuring compliance with institutional policies on AI tools
- Understanding privacy implications of code sent to AI services
- Reviewing and validating all AI-generated code

Review [Utrecht University policies and guidelines](https://www.uu.nl/en/organisation/ai-policy) on AI use before using AI coding assistants.
:::

**Note:** AI coding assistants work with any workspace, though workspaces with Python environment managers (Python Workbench, VRE Lab) may be more convenient for development projects.

For detailed instructions on setting up GitHub Copilot, see [Using GitHub Copilot with VS Code.](../manuals/github-copilot.qmd)
