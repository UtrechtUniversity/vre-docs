...
## Select your data transfer tool
```{ojs}
//| echo: false
...
isDesktop = workspaceType === "Python Workbench (Desktop)" || workspaceType === "Windows" || workspaceType === "Ubuntu (Desktop)" || workspaceType === "VRE Lab"
  ...
  if (dataSource === "Yoda/iRODS") {
    ...
    if (!isWindows) {
      options.push({
        ...
        cons: ["Requires command line knowledge", "Not pre-installed on all workspaces", "Not available on Windows"],
