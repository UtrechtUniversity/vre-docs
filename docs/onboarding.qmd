...
### 3. Share your wallet
In SRAM there are [groups](https://wiki.surfnet.nl/display/SRAM/Manage+groups+of+collaboration+members) that can be used to grant members of your collaboration to the right to [create new workspaces using the wallet of your project](https://servicedesk.surf.nl/wiki/display/WIKI/Access+to+project+wallet)
